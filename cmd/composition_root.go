...
import (
	...
	kafkabasket "delivery/internal/adapters/in/kafka"
...
func (cr *CompositionRoot) NewBasketConfirmedConsumer() kafkabasket.BasketConfirmedConsumer {
	consumer, err := kafkabasket.NewBasketConfirmedConsumer(
